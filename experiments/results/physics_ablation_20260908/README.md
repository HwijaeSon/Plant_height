...
|---|---|---:|---:|---:|
| Wheat | PhytoODE (K loss only) | -0.00016 | -0.51 | 2/3 |
| Wheat | Latent Neural ODE (no physics) | +0.00028 | +0.93 | 2/3 |
| Maize | PhytoODE (K loss only) | -0.85098 | -1.50 | 1/3 |
| Maize | Latent Neural ODE (no physics) | +11.09704 | +19.58 | 3/3 |
| Arabidopsis | PhytoODE (K loss only) | -0.01363 | -0.48 | 2/3 |
| Arabidopsis | Latent Neural ODE (no physics) | +0.12718 | +4.44 | 2/3 |
