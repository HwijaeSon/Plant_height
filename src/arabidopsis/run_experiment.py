...
ROOT = HERE.parents[1]
DEFAULT_DATA = ROOT / "data/arabidopsis/processed/stem_length_long.csv"
DEFAULT_RESULTS = ROOT / "outputs/arabidopsis-baselines"
...
def main() -> None:
    ...
    parser.add_argument("--skip-latent", action="store_true", default=True, help="Compatibility flag; selected latent models are trained with run.py")
