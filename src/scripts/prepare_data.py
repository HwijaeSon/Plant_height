...
def main():
    ...
    commands = {
        "wheat": [],
        "maize": [["src/maize/prepare_data.py"], ["src/maize/data.py", "--split", "chronological"]],
        "arabidopsis": [["src/arabidopsis/prepare_data.py"]],
        "hypocotyl": [["src/scripts/prepare_hypocotyl.py"]],
    }
